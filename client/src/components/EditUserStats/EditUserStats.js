  ...
  render() {
    ...
    for (let i in obj) {
      arr.push(
        <li key={i} className="collection-item avatar">
          <img
            src="http://workoutboss.com/wp-content/uploads/2012/04/WOB-Logo-625x663.jpg"
            alt=""
            className="circle"
          />
          ...
          <div className="row">
            <div className="col s6 input-field">
              ...
              <a
                onClick={() =>
                  this.handleFormSubmit(obj[i], this.state[obj[i]])
                }
                className="waves-effect waves-light btn yellow accent-2"
              >
                Save
              </a>
            </div>
          ...
          <a href="#!" className="secondary-content">
            <i className="material-icons yellow-text text-accent-2">grade</i>
          </a>
        </li>
      );
    }
    ...
    return (
      <div className="col m12">
        <ul className="collection z-depth-3 border">{arr}</ul>
      </div>
    );
  }
}
